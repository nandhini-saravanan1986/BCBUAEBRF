...
import com.bornfire.brf.entities.CBUAE_BRF2_7_Archival_Summary_Entity;
import com.bornfire.brf.entities.CBUAE_BRF2_7_Archival_Summary_Repo;
...
import com.bornfire.brf.entities.CBUAE_BRF2_7__Archival_Detail_Entity;
import com.bornfire.brf.entities.CBUAE_BRF2_7__Archival_Detail_Repo;
...
public class CBUAE_BRF2_7_ReportService {
	...
	@Autowired
	CBUAE_BRF2_7_Archival_Summary_Repo BRF2_7_Archival_Summary_Repo;

	@Autowired
	CBUAE_BRF2_7__Archival_Detail_Repo BRF2_7_archival_detail_repo;
	...
	public ModelAndView getBRF2_7View(String reportId, String fromdate, String todate, String currency, String dtltype,
		...
		if (type.equals("ARCHIVAL") & version != null) {
			List<CBUAE_BRF2_7_Archival_Summary_Entity> T1Master = new ArrayList<CBUAE_BRF2_7_Archival_Summary_Entity>();
			try {
				Date d1 = dateformat.parse(todate);

				T1Master = BRF2_7_Archival_Summary_Repo.getdatabydateListarchival(dateformat.parse(todate), version);
	...
	public List<Object> getBRF2_7Archival() {
		List<Object> BRF2_7Archivallist = new ArrayList<>();
		try {
			BRF2_7Archivallist = BRF2_7_Archival_Summary_Repo.getBRF2_7archival();
			System.out.println("countser" + BRF2_7Archivallist.size());
		} catch (Exception e) {
			// Log the exception
			System.err.println("Error fetching BRF2_7 Archival data: " + e.getMessage());
			e.printStackTrace();

			// Optionally, you can rethrow it or return empty list
			// throw new RuntimeException("Failed to fetch data", e);
		}
		return BRF2_7Archivallist;
	}
	...
	public ModelAndView getBRF2_7currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		ModelAndView mv = new ModelAndView();
		if (type.equals("ARCHIVAL") & version != null) {
			List<CBUAE_BRF2_7__Archival_Detail_Entity> T1Dt1 = new ArrayList<CBUAE_BRF2_7__Archival_Detail_Entity>();
			try {
				Date d1 = dateformat.parse(todate);
				String rowId = null;
				...
				if (rowId != null && columnId != null) {
					T1Dt1 = BRF2_7_archival_detail_repo.GetDataByRowIdAndColumnId(rowId, columnId,
							dateformat.parse(todate), version);

					System.out.println("countavdach" + T1Dt1.size());
				} else {

					T1Dt1 = BRF2_7_archival_detail_repo.getdatabydateList(dateformat.parse(todate), version);
					System.out.println("countavdarch" + T1Dt1.size());
				}
			...
			List<CBUAE_BRF2_7_Detail_Entity> T1Dt1 = new ArrayList<>();
			...
			try {
				...
				if (rowId != null && columnId != null) {
					T1Dt1 = BRF2_7_Detail_Repo.GetDataByRowIdAndColumnId(rowId, columnId, dateformat.parse(todate));
				} else {

					T1Dt1 = BRF2_7_Detail_Repo.getdatabydateList(d1, currentPage, pageSize);
					totalPages = BRF2_7_Detail_Repo.getdatacount(dateformat.parse(todate));
	...
	public byte[] getBRF2_7Excel(String filename, String reportId, String fromdate, String todate, String currency,
			String dtltype, String type, String version) throws Exception {
		logger.info("Service: Starting Excel generation process in memory.");

		if (type.equals("ARCHIVAL") & version != null) {
			byte[] ARCHIVALreport = getBRF2_7ExcelARCHIVAL(filename, reportId, fromdate, todate, currency, dtltype,
					type, version);
	...
	public byte[] getBRF2_7DetailExcel(String filename, String fromdate, String todate, String currency, String dtltype,
		...
		try {
			...
			if (type.equals("ARCHIVAL") & version != null) {
				byte[] ARCHIVALreport = getBRF2_7DetailExcelARCHIVAL(filename, fromdate, todate, currency, dtltype,
						type, version);
				return ARCHIVALreport;
			}

			XSSFWorkbook workbook = new XSSFWorkbook();
			XSSFSheet sheet = workbook.createSheet("BRF2_7Details");
			...
			List<CBUAE_BRF2_7_Detail_Entity> reportData = BRF2_7_Detail_Repo.getdatabydateList(parsedToDate);

			if (reportData != null && !reportData.isEmpty()) {
				int rowIndex = 1;
				for (CBUAE_BRF2_7_Detail_Entity item : reportData) {
				...
				logger.info("No data found for BRF2_7 — only header will be written.");
			}
			...
			logger.error("Error generating BRF2_7 Detail Excel", e);
			return new byte[0];
		}
	}

	public byte[] getBRF2_7DetailExcelARCHIVAL(String filename, String fromdate, String todate, String currency,
			String dtltype, String type, String version) {
		try {
			logger.info("Generating Excel for BRF2_7 ARCHIVAL Details...");
			System.out.println("came to Detail download service");
			if (type.equals("ARCHIVAL") & version != null) {
			...
			Date parsedToDate = new SimpleDateFormat("dd/MM/yyyy").parse(todate);
			List<CBUAE_BRF2_7__Archival_Detail_Entity> reportData = BRF2_7_archival_detail_repo
					.getdatabydateList(parsedToDate, version);

			if (reportData != null && !reportData.isEmpty()) {
				int rowIndex = 1;
				for (CBUAE_BRF2_7__Archival_Detail_Entity item : reportData) {
					XSSFRow row = sheet.createRow(rowIndex++);
			...
			logger.error("Error generating BRF2_7 Archival Detail Excel", e);
			return new byte[0];
		}
	}

	public byte[] getBRF2_7ExcelARCHIVAL(String filename, String reportId, String fromdate, String todate,
			String currency, String dtltype, String type, String version) throws Exception {
		logger.info("Service: Starting Archival Excel generation process in memory.");
		if (type.equals("ARCHIVAL") & version != null) {

		}
		List<CBUAE_BRF2_7_Archival_Summary_Entity> dataList = BRF2_7_Archival_Summary_Repo
		...
		try (InputStream templateInputStream = Files.newInputStream(templatePath);
			...
			if (!dataList.isEmpty()) {
				for (int i = 0; i < dataList.size(); i++) {
					CBUAE_BRF2_7_Archival_Summary_Entity record = dataList.get(i);
					System.out.println("rownumber=" + startRow + i);
					Row row = sheet.getRow(startRow + i);
					if (row == null) {
						row = sheet.createRow(startRow + i);
