...
private static final Logger logger = LoggerFactory.getLogger(CBUAE_BRF2_7_ReportService.class);
	...
	public byte[] getBRF2_7DetailExcel(String filename, String fromdate, String todate, String currency, String dtltype, String type, String version) {
	    try {
	        ...
	        logger.error("Error generating BRF2_7 Excel", e);
	        return new byte[0];
	    }
	}
