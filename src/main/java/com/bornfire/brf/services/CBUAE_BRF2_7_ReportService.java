...
private static final Logger logger = LoggerFactory.getLogger(CBUAE_BRF2_7_ReportService.class);
	...
	public ModelAndView getBRF2_7currentDtl(
	...
	public byte[] getBRF2_7Excel(String filename,String reportId, String fromdate, String todate, String currency, String dtltype, String type, String version) throws Exception {
	...
	public byte[] getBRF2_7DetailExcelARCHIVAL(String filename, String fromdate, String todate, String currency,
		...
		try {
			...
			Date parsedToDate = new SimpleDateFormat("dd/MM/yyyy").parse(todate);
			List<CBUAE_BRF2_7__Archival_Detail_Entity> reportData = BRF2_7_archival_detail_repo.getdatabydateList(parsedToDate, version);
