...
public class CBUAE_BRF16_4_ReportService {
	...
	public ModelAndView getBRF16_4currentDtl(
	    ...
	    try {
	        ...
	        if (rowId != null && columnId != null) {
	            ...
	            T1Dt1 = CBUAE_BRF16_4_Detail_Repos.getdatabydateList(d1,currentPage,pageSize);
				totalPages=CBUAE_BRF16_4_Detail_Repos.getdatacount(d1);
	...
	public byte[] getBRF16_4DetailExcel(String filename, String fromdate, String todate, String currency, String dtltype,
