...
private static final Logger logger = LoggerFactory.getLogger(CBUAE_BRF1_10_ReportService.class);
	...
	public byte[] getBRF1_10Excel(String filename,String reportId, String fromdate, String todate, String currency, String dtltype, String type, String version) throws Exception {
		...
		try (InputStream templateInputStream = Files.newInputStream(templatePath);
			...
			if (!dataList.isEmpty()) {
				for (int i = 0; i < dataList.size(); i++) {
					CBUAE_BRF1_10_Summary_Entity1 record = dataList.get(i);
