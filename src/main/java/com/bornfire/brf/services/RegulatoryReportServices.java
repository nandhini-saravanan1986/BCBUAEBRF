...
public class RegulatoryReportServices {
	...
	public byte[] getDownloadDetailFile(String filename, String fromdate, String todate, String currency,
		...
		if ("BRF1_12Detail".equals(filename)) {
			...
			return CBUAE_BRF5_19_ReportServices.getBRF5_19DetailExcel(filename, fromdate, todate, currency, dtltype,
					type, version);
		}
		return new byte[0];
	}
	...
	public List<Object> getArchival(String rptcode) {
		...
		case "BRF1_8":
			try {
				archivalData = CBUAE_BRF1_8_ReportService.getBRF1_8Archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case "BRF1_9":
			try {
				archivalData = cbuae_brf1_9_reportservice.getBRF1_9Archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case "BRF1_10":
			try {
				archivalData = cbuae_brf1_10_reportservice.getBRF1_10Archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case "BRF1_11":
			try {
				archivalData = cbuae_brf1_11_reportservice.getBRF1_11Archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case "BRF5_1":
			try {
				archivalData = cbuae_brf5_1_reportservice.getBRF5_1Archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case "BRF16_2":
			try {
				archivalData = CBUAE_BRF16_2_ReportServices.getBRF16_2Archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case "BRF5_2":
			try {
				archivalData = cbuae_brf5_2_reportservice.getBRF5_2Archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case "BRF5_3":
			try {
				archivalData = cbuae_brf5_3_reportservice.getBRF5_3Archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case "BRF5_20":
			try {
				archivalData = cbuae_brf5_20_reportservice.getBRF5_20Archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case "BRF8_6":
			try {
				archivalData = CBUAE_BRF8_6_ReportServices.getBRF8_6Archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case "BRF2_14":
			try {
				archivalData = cbuae_brf2_14_reportservice.getBRF2_14Archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case "BRF2_15":
			try {
				archivalData = cbuae_brf2_15_reportservice.getBRF2_14Archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case "BRF16_3":
			try {
				archivalData = CBUAE_BRF16_3_ReportServices.getBRF16_3archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		case "BRF5_19":
			try {
				archivalData = CBUAE_BRF5_19_ReportServices.getBRF5_19Archival();
			} catch (Exception e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
	...
	public void generateReportAsync(String jobId, String filename, String fromdate, String todate, String dtltype,
		...
		if (filename.equals("BRF1_1Detail")) {
			...
			fileData = cbuae_brf1_10_reportservice.getBRF1_10DetailExcel(filename, fromdate, todate, currency, dtltype,
					type, version);
		} else if (filename.equals("BRF1_11Detail")) {
			fileData = cbuae_brf1_11_reportservice.getBRF1_11DetailExcel(filename, fromdate, todate, currency, dtltype,
					type, version);
		} else if (filename.equals("BRF2_14Detail")) {
			...
			fileData = CBUAE_BRF1_8_ReportService.getBRF1_8DetailExcel(filename, fromdate, todate, currency, dtltype,
					type, version);
			...
			fileData = cbuae_brf1_7_reportservice.getBRF1_7DetailExcel(filename, fromdate, todate, currency, dtltype,
					type, version);
		}

		else if (filename.equals("BRF7_4Detail")) {
			fileData = CBUAE_BRF7_4_ReportServices.getBRF7_4DetailExcel(filename, fromdate, todate, currency, dtltype,
					type, version);
		}
			...
			fileData = cbuae_brf5_2_reportservice.getBRF5_2DetailExcel(filename, fromdate, todate, currency, dtltype,
					type, version);
		} else if (filename.equals("BRF5_3Detail")) {
			fileData = cbuae_brf5_3_reportservice.getBRF5_3DetailExcel(filename, fromdate, todate, currency, dtltype,
					type, version);
		} else if (filename.equals("BRF5_20Detail")) {
			fileData = cbuae_brf5_20_reportservice.getBRF5_20DetailExcel(filename, fromdate, todate, currency, dtltype,
					type, version);
		} else if (filename.equals("BRF8_6Detail")) {
			fileData = CBUAE_BRF8_6_ReportServices.getBRF8_6DetailExcel(filename, fromdate, todate, currency, dtltype,
					type, version);
		} else if (filename.equals("BRF16_3Detail")) {
			fileData = CBUAE_BRF16_3_ReportServices.getBRF16_3DetailExcel(filename, fromdate, todate);
	...
	public ModelAndView getReportDetails(String reportId, HttpServletRequest request) {
		...
		try {
		    ...
		    case "BRF2_1":
		        modelAndView = cbuae_brf2_1_reportservice.getViewOrEditPage(
		        		request.getParameter("custId"),
		        		request.getParameter("acctNo"),
		                request.getParameter("formmode"));
		        break;
		    ...
		    case "BRF2_2":
		        modelAndView = cbuae_brf2_2_reportservice.getViewOrEditPage(
		                request.getParameter("custId"),
		                request.getParameter("acctNo"),
		                request.getParameter("formmode"));
		        break;
		...
		try {
			switch (reportId) {
				...
				case "BRF1_3":
					...
					break;
				case "BRF2_1":
					response = cbuae_brf2_1_reportservice.updateDetailEdit(request);
					break;
