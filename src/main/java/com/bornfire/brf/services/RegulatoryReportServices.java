...
public class RegulatoryReportServices {
	...
	public byte[] getDownloadDetailFile(String filename, String fromdate, String todate, String currency,
		...
		if ("BRF1_12Detail".equals(filename)) {
			...
			return cbuae_brf5_20_reportservice.getBRF5_20DetailExcel(filename, fromdate, todate, currency, dtltype, type,
					version);
			...
			return cbuae_brf16_1_reportservice.getBRF16_1DetailExcel(filename, fromdate, todate, currency, dtltype, type,
					version);
			...
			return cbuae_brf5_6_reportservice.getBRF5_6DetailExcel(filename, fromdate, todate, currency, dtltype,
					type, version);
		}
    ...
    public void generateReportAsync(String jobId, String filename, String fromdate,String todate, String dtltype,String type,String currency, String version) {
		...
		byte[] fileData =null;
				...
				if(filename.equals("BRF1_1Detail")) {
					...
					fileData=  cbuae_brf2_5_reportservice.getBRF2_5DetailExcel(filename, fromdate, todate, currency, dtltype, type,
							version);
				}
					 ...
					 fileData= cbuae_brf2_14_reportservice.getBRF2_14DetailExcel(filename, fromdate, todate, currency, dtltype, type,version);
				}
				else if (filename.equals("BRF2_1Detail")) {
					...
					fileData= cbuae_brf2_6_reportservice.getBRF2_6DetailExcel(filename, fromdate, todate, currency, dtltype, type,
							version);
				} 
				
				else if (filename.equals("BRF2_7Detail")) {
					fileData= cbuae_brf2_7_reportservice.getBRF2_7DetailExcel(filename, fromdate, todate, currency, dtltype, type,
							version);
				} 
				else if (filename.equals("BRF2_14Detail")) {
