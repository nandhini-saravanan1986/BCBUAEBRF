...
public class RegulatoryReportServices {
	...
	public ModelAndView getReportView(String reportId, String reportDate, String fromdate, String todate,
		...
		case "BRF5_17":
			repsummary = cbuae_brf5_17_reportservice.getBRF5_17View(reportId, fromdate, todate, currency, dtltype, pageable,type,version);
			break;
		...
		case "BRF2_5":
			repsummary = cbuae_brf2_5_reportservice.getBRF2_5View(reportId, fromdate, todate, currency, dtltype, pageable);
			break;
		...
		case "BRF2_16":
			repsummary = cbuae_brf2_16_reportservice.getBRF2_16View(reportId, fromdate, todate, currency, dtltype, pageable);
			break;
			
		case "BRF2_18":
			repsummary = cbuae_brf2_18_reportservice.getBRF2_18View(reportId, fromdate, todate, currency, dtltype, pageable);
			break;
	...
	public byte[] getDownloadFile(String reportId,String filename, String asondate, String fromdate, String todate, String currency,
		...
		switch (reportId) {
			...
			case "BRF5_17":
				try {
					repfile = cbuae_brf5_17_reportservice.getBRF5_17Excel(filename, reportId, fromdate, todate, currency, dtltype,type,version);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
			...
			case "BRF2_5":
				try {
					repfile = cbuae_brf2_5_reportservice.getBRF2_5Excel(filename, reportId, fromdate, todate, currency, dtltype);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
			...
			case "BRF1_3":
				try {
					repfile = cbuae_brf1_3_reportservice.getBRF1_3Excel(filename, reportId, fromdate, todate, currency, dtltype);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
			...
			case "BRF2_6":
				try {
					repfile = cbuae_brf2_6_reportservice.getBRF2_6Excel(filename, reportId, fromdate, todate, currency, dtltype);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
			...
			case "BRF2_16":
				try {
					repfile = cbuae_brf2_16_reportservice.getBRF2_16Excel(filename, reportId, fromdate, todate, currency, dtltype);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
			...
			case "BRF2_18":
				try {
					repfile = cbuae_brf2_18_reportservice.getBRF2_18Excel(filename, reportId, fromdate, todate, currency, dtltype);
				} catch (Exception e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
	...
	public byte[] getDownloadDetailFile(String filename, String fromdate, String todate) {
	    ...
	    if ("BRF1_12Detail".equals(filename)) {
	    	...
	    	return cbuae_brf5_17_reportservice.getBRF5_17DetailExcel(filename, fromdate, todate);
	    }
