...
public class CBUAE_BRF2_13_ReportService {
	...
	public byte[] getBRF2_13Excel(String filename,String reportId, String fromdate, String todate, String currency, String dtltype) throws Exception {
		logger.info("Service: Starting Excel generation process in memory.");

		List<CBUAE_BRF2_13_Summary_Entity1> dataList =CBUAE_BRF2_13_REPORT_REPO1.getdatabydateList(dateformat.parse(todate)) ;
		List<CBUAE_BRF2_13_Summary_Entity2> dataList1 =CBUAE_BRF2_13_REPORT_REPO2.getdatabydateList(dateformat.parse(todate)) ;
		List<CBUAE_BRF2_13_Summary_Entity3> dataList2 =CBUAE_BRF2_13_REPORT_REPO3.getdatabydateList(dateformat.parse(todate)) ;
		...
		/////ROW13///////////
										...
										if (record.getR0040_aed_amount() != null) {
											cell4.setCellValue(record.getR0040_aed_amount().doubleValue());
