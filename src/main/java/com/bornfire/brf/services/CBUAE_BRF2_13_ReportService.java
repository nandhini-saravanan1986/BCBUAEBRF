...
import com.bornfire.brf.entities.CBUAE_BRF2_13_Archival_DETAIL_Entity;
...
import com.bornfire.brf.entities.CBUAE_BRF2_13_Archival_Summary_Entity1;
import com.bornfire.brf.entities.CBUAE_BRF2_13_Archival_Summary_Entity2;
import com.bornfire.brf.entities.CBUAE_BRF2_13_Archival_Summary_Entity3;
import com.bornfire.brf.entities.CBUAE_BRF2_13_Archival_Summary_Repo1;
import com.bornfire.brf.entities.CBUAE_BRF2_13_Archival_Summary_Repo2;
import com.bornfire.brf.entities.CBUAE_BRF2_13_Archival_Summary_Repo3;
import com.bornfire.brf.entities.CBUAE_BRF2_13_Archival_DETAIL_Repo;
@Component
@Service
...
public class CBUAE_BRF2_13_ReportService {
	...
	@Autowired
	CBUAE_BRF2_13_Archival_Summary_Repo1 CBUAE_BRF2_13_Archival_Summary_Repo1;
	
	@Autowired
	CBUAE_BRF2_13_Archival_Summary_Repo2 CBUAE_BRF2_13_Archival_Summary_Repo2;
	
	@Autowired
	CBUAE_BRF2_13_Archival_Summary_Repo3 CBUAE_BRF2_13_Archival_Summary_Repo3;
	
	@Autowired
	CBUAE_BRF2_13_Archival_DETAIL_Repo CBUAE_BRF2_13_Archival_DETAIL_Repo;
	...
	public ModelAndView getBRF2_13View(String reportId, String fromdate, String todate, String currency, String dtltype,
		...
		if (type.equals("ARCHIVAL") & version != null) {
			...
			List<CBUAE_BRF2_13_Archival_Summary_Entity1> T1Master = new ArrayList<CBUAE_BRF2_13_Archival_Summary_Entity1>();
			List<CBUAE_BRF2_13_Archival_Summary_Entity2> T1Master1 = new ArrayList<CBUAE_BRF2_13_Archival_Summary_Entity2>();
			List<CBUAE_BRF2_13_Archival_Summary_Entity3> T1Master2 = new ArrayList<CBUAE_BRF2_13_Archival_Summary_Entity3>();
			
			try {
				Date d1 = dateformat.parse(todate);
				
				T1Master = CBUAE_BRF2_13_Archival_Summary_Repo1.getdatabydateListarchival(d1, version);
				T1Master1 = CBUAE_BRF2_13_Archival_Summary_Repo2.getdatabydateListarchival(d1, version);
				T1Master2 = CBUAE_BRF2_13_Archival_Summary_Repo3.getdatabydateListarchival(d1, version);
	...
	public ModelAndView getBRF2_13currentDtl(String reportId, String fromdate, String todate, String currency,
		...
		if (type.equals("ARCHIVAL") & version != null) {
			List<CBUAE_BRF2_13_Archival_DETAIL_Entity> T1Dt1 = new ArrayList<CBUAE_BRF2_13_Archival_DETAIL_Entity>();
			try {
				Date d1 = dateformat.parse(todate);
				String rowId = null;
				...
				if (rowId != null && columnId != null) {
					T1Dt1 = CBUAE_BRF2_13_Archival_DETAIL_Repo.GetDataByRowIdAndColumnId(rowId, columnId, dateformat.parse(todate),
							version);

					System.out.println("countavd" + T1Dt1.size());
				} else {

					T1Dt1 = CBUAE_BRF2_13_Archival_DETAIL_Repo.getdatabydateList(dateformat.parse(todate), version,currentPage,pageSize);
					totalPages=CBUAE_BRF2_13_Archival_DETAIL_Repo.getdatacount(dateformat.parse(todate),version);
			...
			try {
				...
				if (rowId != null && columnId != null) {
		            ...
		            T1Dt1 = CBUAE_BRF2_13_DETAIL_REPO.getdatabydateList(d1,currentPage,pageSize);
		            totalPages=CBUAE_BRF2_13_DETAIL_REPO.getdatacount(dateformat.parse(todate));
		            mv.addObject("pagination","YES");
		        }
	...
	public byte[] getBRF2_13Excel(String filename, String reportId, String fromdate, String todate, String currency,
		...
		if (type.equals("ARCHIVAL") & version != null) {
			byte[] ARCHIVALreport = getBRF2_13ExcelARCHIVAL(filename, reportId, fromdate, todate, currency, dtltype,
					type, version);
	...
	public byte[] getBRF2_13ExcelARCHIVAL(String filename, String reportId, String fromdate, String todate, String currency,
			String dtltype,String type,String version) throws Exception {
		logger.info("Service: Starting Excel generation process in memory.");

		List<CBUAE_BRF2_13_Archival_Summary_Entity1> dataList = CBUAE_BRF2_13_Archival_Summary_Repo1.getdatabydateListarchival(dateformat.parse(todate),version);
		List<CBUAE_BRF2_13_Archival_Summary_Entity2> dataList1 = CBUAE_BRF2_13_Archival_Summary_Repo2.getdatabydateListarchival(dateformat.parse(todate), version);
		List<CBUAE_BRF2_13_Archival_Summary_Entity3> dataList2 = CBUAE_BRF2_13_Archival_Summary_Repo3.getdatabydateListarchival(dateformat.parse(todate), version);
		...
		try (InputStream templateInputStream = Files.newInputStream(templatePath);
			...
			if (!dataList.isEmpty()) {
				for (int i = 0; i < dataList.size(); i++) {
					...
					CBUAE_BRF2_13_Archival_Summary_Entity1 record = dataList.get(i);
					System.out.println("rownumber=" + startRow + i);
					Row row = sheet.getRow(startRow + i);
					if (row == null) {
						row = sheet.createRow(startRow + i);
				...
				if (!dataList1.isEmpty()) {
					for (int i = 0; i < dataList1.size(); i++) {
						CBUAE_BRF2_13_Archival_Summary_Entity2 record1 = dataList1.get(i);
					...
					if (!dataList2.isEmpty()) {
						for (int i = 0; i < dataList2.size(); i++) {
							CBUAE_BRF2_13_Archival_Summary_Entity3 record2 = dataList2.get(i);
	...
	// DetailExcel
	public byte[] getBRF2_13DetailExcel(String filename, String fromdate, String todate, String currency, String dtltype,
		...
		try {
			...
			if (type.equals("ARCHIVAL") & version != null) {
				byte[] ARCHIVALreport = getBRF2_13DetailExcelARCHIVAL(filename, fromdate, todate, currency, dtltype,
						type, version);
				return ARCHIVALreport;
			}	
	...
	public byte[] getBRF2_13DetailExcelARCHIVAL(String filename, String fromdate, String todate, String currency, String dtltype,
			String type, String version) {
		try {
			logger.info("Generating Excel for BRF2_13 Details...");
			System.out.println("came to Detail download service");
			...
			// Get data
			Date parsedToDate = new SimpleDateFormat("dd/MM/yyyy").parse(todate);
			List<CBUAE_BRF2_13_Archival_DETAIL_Entity> reportData = CBUAE_BRF2_13_Archival_DETAIL_Repo.getdatabydateList(parsedToDate, version);

			if (reportData != null && !reportData.isEmpty()) {
				int rowIndex = 1;
				for (CBUAE_BRF2_13_Archival_DETAIL_Entity item : reportData) {
					XSSFRow row = sheet.createRow(rowIndex++);
	...
	public List<Object> getBRF2_13Archival() {
		List<Object> BRF2_13Archivallist = new ArrayList<>();
		try {
			BRF2_13Archivallist = CBUAE_BRF2_13_Archival_Summary_Repo1.getbrfarchival();
			System.out.println(BRF2_13Archivallist.size());
		} catch (Exception e) {
			// Log the exception
