...
public class CBUAE_BRF2_3_ReportService {
	...
	//DetailExcel
	public byte[] getBRF2_3DetailExcel(String filename, String fromdate, String todate) {
	    try {
	...
	public byte[] getBRF2_3Excel(String filename,String reportId, String fromdate, String todate, String currency, String dtltype) throws Exception {
		logger.info("Service: Starting Excel generation process in memory.");

		List<CBUAE_BRF2_3_Summary_Entity> dataList =CBUAE_BRF2_3_SUMMARY_REPO.getdatabydateList(dateformat.parse(todate)) ;
