...
public class CBUAE_BRF2_15_ReportService {
	...
	public ModelAndView getBRF2_15View(String reportId, String fromdate, String todate, String currency, String dtltype,
		...
		if (type.equals("ARCHIVAL") & version != null) {
			...
			try {
				...
				T1Master = CBUAE_BRF2_15_Summary_Archival_Repo.getdatabydateListarchival(d1, version);
	...
	public List<Object> getBRF2_14Archival() {
		...
		try {
			BRF2_15Archivallist = CBUAE_BRF2_15_Summary_Archival_Repo.getbrfarchival();
			System.out.println(BRF2_15Archivallist.size());
		} catch (Exception e) {
			// Log the exception
