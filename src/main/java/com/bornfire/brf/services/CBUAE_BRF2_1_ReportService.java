...
import com.bornfire.brf.entities.CBUAE_BRF2_1_REPORT_ENTITY;
import com.bornfire.brf.entities.CBUAE_BRF2_1_REPORT_Repo;
...
public class CBUAE_BRF2_1_ReportService {
	...
	@Autowired
	CBUAE_BRF2_1_REPORT_Repo BRF2_1_REPORT_Repo;
	...
	public ModelAndView getBRF2_1View(String reportId, String fromdate, String todate, String currency, String dtltype,
		...
		List<CBUAE_BRF2_1_REPORT_ENTITY> T1Master = new ArrayList<CBUAE_BRF2_1_REPORT_ENTITY>();
		try {
