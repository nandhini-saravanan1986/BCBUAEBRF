...
@Entity
@Table(name = "CBUAE_BRF8_6_SUMMARYTABLE")
public class CBUAE_BRF8_6_Summary_Entity {
	...
	public CBUAE_BRF8_6_Summary_Entity(Long id, String r0010_outsourced_activity_domain,
			String r0020_description_of_outsourced_activity, String r0030_name_of_institution,
			String r0040_department_responsible, String r0050_outsourcing_activity_core_noncore,
			String r0060_cbuae_no_objection_reference, String r0070_total_number_of_outsourced_jobs,
			String r0080_number_of_critical_outsourced_jobs, String r0090_data_access_by_third_parties,
			String r0100_nature_of_data_involved, String r0110_is_service_provider_owned_by_bank,
			String r0120_name_of_vendor, String r0130_country_of_registration, String r0140_vendor_lei_or_reg_number,
			String r0150_holding_parent_company, String r0160_countries_service_performed,
			String r0170_countries_data_stored, String r0180_governing_law, BigDecimal r0190_annual_contract_value_aed,
			BigDecimal r0200_total_contract_value_aed, Date r0210_service_commencement_date,
			Date r0220_service_expiry_date, String r0230_outcome_of_risk_assessment, String r0240_substitutability,
			String r0250_time_critical_operation, Date r0260_last_audit_date, String r0270_comments, Date report_date,
	...
	public CBUAE_BRF8_6_Summary_Entity() {
		super();
