...
public interface CBUAE_BRF16_2_SUMMARY_REPO extends JpaRepository<CBUAE_BRF16_2_Summary_Entity, Long> {

	@Query(value = "select * from CBUAE_BRF16_2_SUMMARYTABLE ORDER BY ID", nativeQuery = true)
	List<CBUAE_BRF16_2_Summary_Entity> getdatabydateList();
