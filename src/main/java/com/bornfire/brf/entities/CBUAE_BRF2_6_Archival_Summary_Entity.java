...
import org.springframework.format.annotation.DateTimeFormat;
	@Entity
	@Table(name = "CBUAE_BRF2_6_ARCHIVALTABLE_SUMMARY")

	public class CBUAE_BRF2_6_Archival_Summary_Entity {
		...
		private String	r0030_total_resident;
	...
	public String getR0030_total_resident() {
		return r0030_total_resident;
	}
	public void setR0030_total_resident(String r0030_total_resident) {
	...
	public CBUAE_BRF2_6_Archival_Summary_Entity() {
		super();
