...
@Entity
@Table(name = "CBUAE_BRF16_2_ARCHIVALTABLE_DETAIL", schema = "CXBRL")
public class CBUAE_BRF16_2_Archival_Detail_Entity {
	...
	public CBUAE_BRF16_2_Archival_Detail_Entity() {
		super();
