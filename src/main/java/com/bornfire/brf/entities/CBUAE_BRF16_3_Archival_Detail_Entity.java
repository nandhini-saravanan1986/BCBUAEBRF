...
@Entity
@Table(name = "CBUAE_BRF16_3_ARCHIVAL_DETAILTABLE", schema = "CXBRL")
public class CBUAE_BRF16_3_Archival_Detail_Entity {
		...
		public CBUAE_BRF16_3_Archival_Detail_Entity() {
			super();
