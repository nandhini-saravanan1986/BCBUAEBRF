...
public interface RRReportRepo extends JpaRepository<RRReport, Integer> {
	@Query(value = "select * from CBUAE_RR_RPT_MAST WHERE REMARKS_5 = 'M1' ORDER BY rpt_code", nativeQuery = true)
	List<RRReport> getReportListmonthly1();
	
	@Query(value = "select * from CBUAE_RR_RPT_MAST WHERE REMARKS_5 = 'M2' ORDER BY rpt_code", nativeQuery = true)
	List<RRReport> getReportListmonthly2();

	@Query(value = "select * from CBUAE_RR_RPT_MAST WHERE REMARKS_5 = 'M3' ORDER BY rpt_code", nativeQuery = true)
	List<RRReport> getReportListmonthly3();
	

	@Query(value = "select * from CBUAE_RR_RPT_MAST WHERE REMARKS_5 = 'HY1' ORDER BY rpt_code", nativeQuery = true)
	List<RRReport> getReportHalfYearly1();
	
	@Query(value = "select * from CBUAE_RR_RPT_MAST WHERE REMARKS_5 = 'Y1' ORDER BY rpt_code", nativeQuery = true)
	List<RRReport> getReportYearly1();
	
	
	@Query(value = "select * from CBUAE_RR_RPT_MAST WHERE REMARKS_5 = 'FN' ORDER BY rpt_code", nativeQuery = true)
