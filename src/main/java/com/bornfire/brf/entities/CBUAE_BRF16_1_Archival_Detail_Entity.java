...
@Entity
@Table(name = "CBUAE_BRF16_1_ARCHIVALTABLE_DETAIL", schema = "CXBRL")
public class CBUAE_BRF16_1_Archival_Detail_Entity {
	...
	public CBUAE_BRF16_1_Archival_Detail_Entity() {
		super();
