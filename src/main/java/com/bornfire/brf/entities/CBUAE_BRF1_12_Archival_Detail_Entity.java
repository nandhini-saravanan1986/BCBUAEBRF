...
@Entity
@Table(name = "CBUAE_BRF1_12_ARCHIVALTABLE_DETAIL", schema = "CXBRL")
public class CBUAE_BRF1_12_Archival_Detail_Entity {
	...
	public CBUAE_BRF1_12_Archival_Detail_Entity() {
		super();
