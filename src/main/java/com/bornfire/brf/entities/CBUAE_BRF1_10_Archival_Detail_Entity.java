...
@Entity
@Table(name = "CBUAE_BRF1_10_ARCHIVALTABLE_DETAIL", schema = "CXBRL")

public class CBUAE_BRF1_10_Archival_Detail_Entity {
	...
	public CBUAE_BRF1_10_Archival_Detail_Entity() {
		super();
