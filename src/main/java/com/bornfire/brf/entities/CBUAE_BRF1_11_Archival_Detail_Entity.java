...
@Entity
@Table(name = "CBUAE_BRF1_11_ARCHIVALTABLE_DETAIL", schema = "CXBRL")

public class CBUAE_BRF1_11_Archival_Detail_Entity {
	...
	public CBUAE_BRF1_11_Archival_Detail_Entity(String custId, String acctNumber, String acctName, String dataType,
			String rowId, String columnId, String reportRemarks, String modificationRemarks, String dataEntryVersion,
	...
	public CBUAE_BRF1_11_Archival_Detail_Entity() {
		super();
