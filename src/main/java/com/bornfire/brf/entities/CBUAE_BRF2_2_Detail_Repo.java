...
public interface CBUAE_BRF2_2_Detail_Repo extends JpaRepository<CBUAE_BRF2_2_Detail_Entity, String> {
	...
	@Query(value = "select * from CBUAE_BRF2_2_DETAILTABLE where ROW_ID =?1 and COLUMN_ID=?2", nativeQuery = true)
	List<CBUAE_BRF2_2_Detail_Entity> GetDataByRowIdAndColumnId(String rowId,String ColumnId);
}