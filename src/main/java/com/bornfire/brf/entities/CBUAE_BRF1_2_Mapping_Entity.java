...
@Entity
@Table(name = "CBUAE_BRF1_2_MAPPING_TABLE")
public class CBUAE_BRF1_2_Mapping_Entity {
	...
	public CBUAE_BRF1_2_Mapping_Entity(String foracid, String br_code, String sol_id, String cust_id, String glsh_code,
	...
	public CBUAE_BRF1_2_Mapping_Entity() {
		super();
