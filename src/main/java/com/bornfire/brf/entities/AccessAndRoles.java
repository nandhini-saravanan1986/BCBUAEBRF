...
public class AccessAndRoles {
	...
	public int hashCode() {
	    ...
	    result = prime * result + ((brfReports == null) ? 0 : brfReports.hashCode());
	...
	public boolean equals(Object obj) {
	    ...
	    if (newRoleFlg == null) {
	        ...
	        return false;
	    if (brfReports == null) {
	        if (other.brfReports != null)
	            return false;
	    } else if (!brfReports.equals(other.brfReports))
	        return false;
	    if (entityFlg == null) {
	...
	public String toString() {
		return "AccessAndRoles [roleId=" + roleId + ", roleDesc=" + roleDesc + ", permissions=" + permissions
				...
				+ ", newRoleFlg=" + newRoleFlg + ", brfReports=" + brfReports + ", ARCHIVALS="
